...
var rTerm = function(options) {
  ...
  this.callUpstart = function() {
    ...
    delay +=
      (this.data.upstart[this.data.upstart.length - 1].length + 1) *
      this.chartime;
    return delay;
  };
  ...
  this.keyCallback = function(event) {
    ...
    } else if (event.which == 8 || event.which == 46 || event.which == 110) {
      this.delCallback();
  ...
  this.lsCallback = function(args) {
    ...
    if (typeof dirData === "undefined") {
      this.oldInput +=
        "ls: cannot access '" + lsdir + "': No such file or directory" + "<br>";
      this.nStrings++;
    } else {
      for (item in dirData) {
  ...
  this.unameCallback = function() {
    this.oldInput +=
      this.termPrev + this.input + "<br>" + this.data.uname + "<br>";
    this.input = "";
    this.nStrings += 2;
    this.updateTerm();
  }.bind(this);
  ...
  this.randomCallback = function() {
    this.oldInput +=
      this.termPrev + this.input + "<br>" + String(Math.random()) + "<br>";
    this.input = "";
    this.nStrings += 2;
    this.updateTerm();
  }.bind(this);
  ...
  this.manCallback = function() {
    this.oldInput +=
      this.termPrev + this.input + "<br>What manual page do you want?<br>";
    this.nStrings += 2;
    this.input = "";
    this.updateTerm();
  }.bind(this);
  ...
  this.sudoCallback = function(args) {
    if (args.length == 1) {
      this.oldInput +=
        this.termPrev + this.input + "<br>usage: sudo [options] [command]<br>";
      this.nStrings += 2;
      this.input = "";
      this.updateTerm();
